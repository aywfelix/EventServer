...
public:
    ...
    bool SendPackToLogin(socket_t client_fd, const int msg_id, const char *msg, uint32_t msg_len, int nGameID, const std::string &ip);
    ...
    void OnLoginRouteBack(socket_t sock_fd, const int msg_id, const char *msg, const uint32_t msg_len);
    void OnChatRouteBack(socket_t sock_fd, const int msg_id, const char *msg, const uint32_t msg_len);
    void OnWorldRouteBack(socket_t sock_fd, const int msg_id, const char *msg, const uint32_t msg_len);
};