...
// bytes account_id = 3;
inline void Login_LoginReq::clear_account_id() {
  account_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Login_LoginReq::account_id() const {
  // @@protoc_insertion_point(field_get:Login_LoginReq.account_id)
  return _internal_account_id();
}
inline void Login_LoginReq::set_account_id(const std::string& value) {
  _internal_set_account_id(value);
  // @@protoc_insertion_point(field_set:Login_LoginReq.account_id)
}
inline std::string* Login_LoginReq::mutable_account_id() {
  // @@protoc_insertion_point(field_mutable:Login_LoginReq.account_id)
  return _internal_mutable_account_id();
}
inline const std::string& Login_LoginReq::_internal_account_id() const {
  return account_id_.GetNoArena();
}
inline void Login_LoginReq::_internal_set_account_id(const std::string& value) {
  
  account_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Login_LoginReq::set_account_id(std::string&& value) {
  
  account_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:Login_LoginReq.account_id)
}
inline void Login_LoginReq::set_account_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  account_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Login_LoginReq.account_id)
}
inline void Login_LoginReq::set_account_id(const void* value, size_t size) {
  
  account_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Login_LoginReq.account_id)
}
inline std::string* Login_LoginReq::_internal_mutable_account_id() {
  
  return account_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Login_LoginReq::release_account_id() {
  // @@protoc_insertion_point(field_release:Login_LoginReq.account_id)
  
  return account_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Login_LoginReq::set_allocated_account_id(std::string* account_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Login_LoginReq.account_id)
}
